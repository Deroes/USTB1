...
%
% Reviewer #1 (comment 6): panels (a), (b) and (c) show the transmit wave
% apodization weight maps for scanline, multiple-line (MLA) and RTB
% beamforming. They must share the SAME colorbar range so they are directly
% comparable. This script regenerates all six panels with a common colour
% scale ([0 1] for the weight maps, a common dynamic range for the images).
%
...
% Common display ranges (the reviewer fix).
